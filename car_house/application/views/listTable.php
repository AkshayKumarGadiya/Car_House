...
<html>
    ...
    <body class="m-listTable" data-scrolling-animations="true" data-equal-height=".b-items__cell" onload="viewmore(<?php if($this->uri->segment(2) != "") { echo $this->uri->segment(2); }else { echo "0"; }?>,9)">
        ...
        <div class="b-infoBar">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-xs-12 narendra">
                        <div class="b-infoBar__compare wow zoomInUp" data-wow-delay="0.5s">
                            ...
                            <form method="post">
                                ...
                                <a class="b-infoBar__compare-item" href="" id="compare"><span class="fa fa-compress"></span>COMPARE VEHICLES</a>
                            </form>
                            <?php
                            }
                            else
        ...
        <div class="b-items" style="padding-top: 37px;padding-bottom: 10px;">
            <div class="container">
                <div class="row">
