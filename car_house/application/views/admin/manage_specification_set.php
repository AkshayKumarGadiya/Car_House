                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <div class="col-sm-12 col-xs-12 col-md-12 text-justify text-center">
                                         Are You Sure You Want To Delete Specification Set ?    
                                    </div>
                                    <br/>
                                    <br/>
                                    <div class="col-sm-12 col-xs-12 col-md-12 text-center">
                                        <a href="<?php echo base_url(); ?>Delete/attributeset/" id="cyes"><button type="button" class="btn pl-xl pr-xl" name="yes" value="yes" style="background-color: #FF6200;color: white;">Yes</button></a>
            ...
            <div class="inner-wrapper">
                ...
                <section role="main" class="content-body">
                    <header class="page-header">
                        <h2>Manage Specification Set</h2>
                        ...
                        <div class="right-wrapper pull-right">
                            <ol class="breadcrumbs">
                                ...
                                <li><span class="dashboardname">Manage Specification Set</span></li>
                            </ol>
                        </div>
                    </header>
                                        ...
                                        <div class="panel panel-accordion panel-accordion-first">
                                            <div id="collapse1One" class="accordion-body collapse in">
                                                <div class="panel-body">
                                                    ...
                                                    {
                                                    ?>
                                                    <form method="post"class="sbox my-form" novalidate="" >
                                                        <P style="font-size: 15px;">Update Specification Set</P>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="ucompany" required="" onchange="set_combo(this.value,'model')" id="company">
                                                                ...
                                                                <?php
                                                                    if($this->input->post('uptype') != "")
                                                                    {
                                                                        $com = $this->md->my_select('tbl_category',array('label'=>'company','parent_id'=>$this->input->post('uptype')));
                                                                        foreach ($com as $val)
                                                                        {
                                                                ?>
                                                                <option value="<?php echo $val->category_id; ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="upmodel" required="" id="model">
                                                                ...
                                                                <?php
                                                                    if($this->input->post('ucompany') != "")
                                                                    {
                                                                        $model = $this->md->my_select('tbl_category',array('label'=>'model','parent_id'=>$this->input->post('ucompany')));
                                                                ...
                                                                <option value="<?php echo $val->category_id; ?>"
                                                                        <?php 
                                                                                if($this->input->post('update'))
                                                                                {
                                                                                    if(set_select('upmodel',$val->location_id))
                                                                                    {
                                                                                        echo 'selected';
                                                                                    }
                                                                                }
                                                                                ...
                                                                                {
                                                                                    if($upmodel[0]->category_id == $val->category_id)
                                                                                    {
                                                                                        echo 'selected';
                                                                                    }
                                                                                }
                                                        ...
                                                        <div class="col-md-6" style="margin-top: 3px;">
                                                            <input type="text" name="upsetname" placeholder="Set name" value="<?php if($this->input->post('update')) { echo set_value('upsetname'); }else{ echo $upspecification[0]->set_name; }?>" class="form-control input-md" required="" pattern="^[a-zA-Z ]+$"/>
                                                            <p class="errmsg"><?php echo form_error('upsetname'); ?></p>
                                                        </div>
                                                        <div class="col-md-12 col-xs-12 text-right" style="padding: 20px 15px 10px 0px;">
                                                            ...
                                                            <a href="<?php echo base_url()?>Manage-Specification-Set"><button type="button" class="btn btnemail1"><i class="fa fa-close"></i>Cancel</button></a>
                                                            <br/>
                                                            <br/>
                                                            <?php
                                                            if(isset($error))
                                                    ...
                                                    ?>
                                                    <form method="post"class="sbox my-form" novalidate="" >
                                                        <P style="font-size: 15px;">Add New Specification Set</P>
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="company" required="" onchange="set_combo(this.value,'model')" id="company">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    {
                                                                        $com = $this->md->my_select('tbl_category',array('label'=>'company','parent_id'=>$this->input->post('type')));
                                                                        foreach ($com as $val)
                                                                        {
                                                                ?>
                                                                <option value="<?php echo $val->category_id; ?>"
                                                        ...
                                                        <div class="col-md-6">
                                                            <select name="model" required="" id="model">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    {
                                                                        $model = $this->md->my_select('tbl_category',array('label'=>'model','parent_id'=>$this->input->post('company')));
                                                                        foreach ($model as $val)
                                                                        {
                                                                ?>
                                                                <option value="<?php echo $val->category_id; ?>"
                                                        ...
                                                        <div class="col-md-6" style="margin-top: 3px;">
                                                            <input type="text" name="setname" placeholder="Set name" value="<?php if(!isset($success)) { echo set_value('setname'); } ?>" class="form-control input-md" required="" pattern="^[a-zA-Z ]+$"/>
                                                            <p class="errmsg"><?php echo form_error('setname'); ?></p>
                                                        </div>
                                                        <div class="col-md-12 col-xs-12 text-right" style="padding: 20px 15px 10px 0px;">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $val->set_name; ?></td>
                                                    <td style="width:5%"><a href="<?php echo base_url(); ?>Update-Specification-Set/<?php echo $val->set_id; ?>" title="Edit"><i class="fa fa-pencil edit" ></i></a></td>
                                                    <td style="width:5%"><i id='<?php echo $val->set_id; ?>' class="fa fa-trash trash layer" title="Remove" style="color: #76768F;"></i></td>
                                                </tr>
                                            <?php
                                                }
                                            ?>
