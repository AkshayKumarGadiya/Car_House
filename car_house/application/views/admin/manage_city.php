                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12 col-xs-12 col-md-12 text-center">
                                        <a href="<?php echo base_url(); ?>Delete/city/" id="cyes"><button type="button" class="btn pl-xl pr-xl" name="yes" value="yes" style="background-color: #FF6200;color: white;">Yes</button></a>
                    ...
                    <header class="page-header">
                        ...
                        <div class="right-wrapper pull-right">
                            <ol class="breadcrumbs">
                                ...
                                <li><span class="dashboardname">Manage City</span></li>
                            </ol>
                        </div>
                    </header>
                                                        ...
                                                        <div id="collapse1One" class="accordion-body collapse in">
                                                            <div class="panel-body">
                                                                ...
                                                                <form method="post" novalidate="" class="sbox my-form" style="border: none;">
                                                                        ...
                                                                        <option value="<?php echo $val->location_id; ?>"
                                                                         <?php
                                                                            ...
                                                                            else
                                                                            {
                                                                                ...
                                                                                {
                                                                                    if($val->location_id == $updatecity[0]->parent_id)
                                                                                    {
                                                                                        echo "selected";
                                                                                    }
                                                                                }
                                                                    ...
                                                                    <input type="text" placeholder="City" name="upcity" value="<?php if($this->input->post('update')) { echo set_value('upcity'); }else{ echo $updatecity[0]->name; } ?>" class="form-control input-md" required="" pattern="^[a-zA-Z]+$"/> 
                                                                    ...
                                                                    <div class="col-md-12 col-xs-12" style="padding: 20px 0 10px 0;">
                                                                        ...
                                                                        <a href="<?php echo base_url(); ?>Manage-City"><button type="button" class="btn btnemail1"><i class="fa fa-close"></i>Cancel</button></a>
                                                                        <br/>
                                                                        <br/>
                                                                            <?php
                                                                            if(isset($error))
                                                                ...
                                                                <form method="post" novalidate="" class="sbox my-form" style="border: none;">
                                                                    ...
                                                                    <select name="state" required="">
                                                                        ...
                                                                        <option value="<?php echo $val->location_id; ?>"
                                                                        <?php
                                                                            if(set_select('state',$val->location_id) && !isset($success))
                                                                            {
                                                                                echo "selected";
                                                                            }
                                                                        ?>>
                                                                    ...
                                                                    <input type="text" placeholder="City" name="city" value="<?php if(!isset($success)){ echo set_value('city'); } ?>" class="form-control input-md" required="" pattern="^[a-zA-Z]+$"/> 
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td style="width:10%"><a href="<?php echo base_url(); ?>Update-City/<?php echo $val->location_id; ?>" title="Edit"><i class="fa fa-pencil edit"/></i></a></td>
