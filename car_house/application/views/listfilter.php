            ...
            <form method="post" id="filter-data">
                <div class="b-items__aside-main-body">
                    <div class="b-items__aside-main-body-item">
                        ...
                        <div>
                            <select name="type" class="m-select" onchange="set_combo(this.value,'company');set_combo(0,'model');set_combo(0,'submodel');carfilterlist()">
                    ...
                    <div class="b-items__aside-main-body-item">
                        ...
                        <div>
                            <select name="company" id="company" onchange="set_combo(this.value,'model');carfilterlist()" class="m-select">
                    ...
                    <div class="b-items__aside-main-body-item">
                        ...
                        <div>
                            <select name="model" id="model" onchange="set_combo(this.value,'submodel');carfilterlist()" class="m-select">
                    ...
                    <div class="b-items__aside-main-body-item">
                        ...
                        <div>
                            <select name="submodel" id="submodel" onchange="carfilterlist()" class="m-select">
                                <option value="" selected="">Select Car Submodel</option>
                            </select>
                            <span class="fa fa-caret-down"></span>
                        </div>
                    </div>
                    <div class="b-items__aside-main-body-item" onclick="carfilterlist()">
                        <div class="">
                            <h1></h1>
                            ...
                            <input id="slide" name="slide" type="range" min="0" max="6850000" value="0" oninput="displayValue(event)" onchange="carfilterlist()" />
                        </div>
                    </div>
                </div>
