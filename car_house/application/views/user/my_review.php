                           ...
                           <div class="panel">
                               ...
                               <div class="panel-body">
                                   <div class="col-sm-12 col-xs-12 col-md-12 text-justify text-center">
                                        Are You Sure You Want To Delete Car Review ?    
                                   </div>
                                   <br/>
                                   <br/>
                                   <div class="col-sm-12 col-xs-12 col-md-12 text-center">
                                       <a href="<?php echo base_url(); ?>Del/review/" id="cyes"><button type="button" class="btn pl-xl pr-xl" name="yes" value="yes" style="background-color: #FF6200;color: white;">Yes</button></a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php
                                                    $img = $this->md->my_select('tbl_car_image',array('car_id'=>$val->car_id));
                                                    $detail = $this->md->my_select('tbl_car_detail',array('car_id'=>$img[0]->car_id));
                                                    ?>
                                                    <td style="width: 20%"><img src="<?php echo base_url().$img[0]->path; ?>" style="width: 105px;height: 78px;"></td>
                                                    <td style="width: 20%"><?php echo $detail[0]->carname; ?></td>
                                                    <td style="width: 40%"><?php echo $val->review; ?></td>
                                                    <td style="width: 10%"><?php echo date('d-m-Y h:i:s',strtotime($val->date)); ?></td>
                                                    <td style="width: 5%"><i id="<?php echo $val->review_id; ?>" class="fa fa-trash trash layer" style="font-size: 15px;" title="Remove"></i></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
